...
class MyLiveChat
{
	...
	public function mylivechat_code()
	{
		...
		else
		{
			...
			{
				echo $sptpre."<div id=\"MyLiveChatContainer\"></div><script type=\"text/javascript\" src=\"https://www.mylivechat.com/chatbutton.aspx?hccid=".$this->get_mylivechat_id()."\"></script>".$sptend;
			}
			else if($this->get_mylivechat_displaytype()=="box")
			{
				echo $sptpre."<div id=\"MyLiveChatContainer\"></div><script type=\"text/javascript\" src=\"https://www.mylivechat.com/chatbox.aspx?hccid=".$this->get_mylivechat_id()."\"></script>".$sptend;
			}
			else
			{
				echo $sptpre."<div id=\"MyLiveChatContainer\"></div><script type=\"text/javascript\" src=\"https://www.mylivechat.com/chatlink.aspx?hccid=".$this->get_mylivechat_id()."\"></script>".$sptend;
			}
		}
	}
